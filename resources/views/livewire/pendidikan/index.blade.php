<div>
    ...
    <form action="" wire:submit.prevent='store' method="post">
        <div class="d-flex justify-content-between gap-3">
            <input type="text" class="form-control" wire:model='jenjang' placeholder="Pendidikan">
        ...
        <table class="table table-sm">
            <th class="text-xs"ead>
                <tr>
                    ...
                    <th class="text-xs">Pendidikan</th>
                    <th class="text-xs">Aksi</th>
                </tr>
            </thead>
            <tbody wire:sortable='pendidikanOrder'>
                ...
                <tr wire:sortable.item='{{$item->id}}' wire:key='item-{{$item->id}}' wire:sortable.handle>
                    ...
                    <td class="text-xs">{{$item->jenjang}}</td>
                    <td class="text-xs">
